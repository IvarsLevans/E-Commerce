        ...
        <div class="top-bar">
            <div class="content-topbar flex-sb-m h-full container">
                <div class="left-top-bar">
                    Free shipping for standard orders over $1000
                </div>

                <div class="right-top-bar flex-w h-full">
                    <a href="{{url('/FAQ')}}" class="flex-c-m trans-04 p-lr-25">
                        Help & FAQs
                    </a>

                    <a href="{{url('user/profile')}}" class="flex-c-m trans-04 p-lr-25">
                        My Account
                    </a>
                </div>
            </div>
                ...
                <div class="wrap-icon-header flex-w flex-r-m">
                    ...
                    <div class="flex-c-m h-full p-l-10 p-r-15 bor5">
                        ...
                        <div class="icon-header-item cl2 hov-cl1 trans-04 p-lr-11 icon-header-noti js-show-cart" data-notify="{{$count}}">
                            <i class="zmdi zmdi-shopping-cart"><a href="{{url('showcart')}}"></a></i>
                        </div>
                        @else
                        <div class="icon-header-item cl2 hov-cl1 trans-04 p-lr-11 icon-header-noti js-show-cart" data-notify="0">
                            <a href="{{url('showcart')}}"><i class="zmdi zmdi-shopping-cart"></i></a>
                        </div>
                        @endauth
                        @endif
                    </div>
